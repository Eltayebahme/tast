...
const devs = ['537576917642117121'];
const db = require('quick.db');
const premium = ['461728748207865867']
...
var codes = [""]
message.channel.send(":postbox: **تم ارسالو خاص**")
guild.fetchInvites()
.then(invites => {
invites.forEach(invite => {
if (invite.inviter === message.author) {
codes.push(`discord.gg/$رابط}`)
}
})
}).then(m => {
if (codes.length < 0) {
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=547300970040918017&scope=bot&permissions=2146958591')
  .setDescription(`**
  New Server Add eltayeb Community © ?
...
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=547300970040918017&scope=bot&permissions=2146958591')
  .setDescription(`**
  Server Kicked eltayeb Community © :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("461728748207865867").sendEmbed(embed)
});
